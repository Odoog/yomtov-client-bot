...
class Database:
    ...
    def is_user_exist(chat_id: str) -> bool:
        data = Database._run("select * from users where chat_id = %s", (chat_id,))
        return len(data) > 0
    ...
    def add_user(chat_id: str,
        ...
        Database._run("insert into users(chat_id, stage_history, user_variables) values (%s, %s, %s)",
    ...
    def delete_user(chat_id: str):
        Database._run("delete from users where chat_id = %s", (chat_id,))
    ...
    def change_user_column(chat_id: str, column_name: str, column_value: object):
        ...
        data = Database._run("update users set {} = %s where chat_id = %s".format(column_name), (column_value, chat_id))
    ...
    def change_scope_column(column_name: str, column_value: object):
        ...
        data = Database._run("update scopes set {} = %s".format(column_name), (column_value,))
